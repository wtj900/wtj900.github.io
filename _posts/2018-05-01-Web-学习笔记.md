...
![](https://wtj900.github.io/img/web/web-css-Inheritance-01.png)
...
`important`是英语里面的“重要的”的意思,我们可以通过语法来给一个属性提高权重,这个属性的权重就是无穷大。
...
![](https://wtj900.github.io/img/web/web-css-box-model-01.png)

代码演示：

![](https://wtj900.github.io/img/web/web-css-box-model-02.png)
...
![](https://wtj900.github.io/img/web/web-css-box-model-03.png)
...
![](https://wtj900.github.io/img/web/web-css-box-model-04.png)

比如，border:10px ridge red;  在chrome和firefox、IE中有细微差别：

![](https://wtj900.github.io/img/web/web-css-box-model-05.png)
...
![](https://wtj900.github.io/img/web/web-css-margin-01.png)

如果不在标准流，比如盒子都浮动了，那么两个盒子之间是没有塌陷现象的：

![](https://wtj900.github.io/img/web/web-css-margin-02.png)
...
![](https://wtj900.github.io/img/web/web-css-margin-03.png)
...
![](https://wtj900.github.io/img/web/web-css-box-model-06.png)
...
![](https://wtj900.github.io/img/web/web-css-box-model-07.png)
...
![](https://wtj900.github.io/img/web/web-css-box-model-08.png)
...
![](https://wtj900.github.io/img/web/web-css-box-model-09.png)
...
![](https://wtj900.github.io/img/web/web-css-float-cancel-01.png)
...
![](https://wtj900.github.io/img/web/web-css-float-cancel-02.png)

只要浮动在一个有高度的盒子中，那么这个浮动就不会影响后面的浮动元素。所以就是清除浮动带来的影响了。

![](https://wtj900.github.io/img/web/web-css-float-cancel-03.png)
...
![](https://wtj900.github.io/img/web/web-css-float-cancel-04.png)
...
![](https://wtj900.github.io/img/web/web-css-float-cancel-05.png)

本意就是清除溢出到盒子外面的文字。但是，前端开发工程师又发现了，它能做偏方。

一个父亲不能被自己浮动的儿子，撑出高度。但是，只要给父亲加上overflow:hidden; 那么，父亲就能被儿子撑出高了。这是一个偏方。

![](https://wtj900.github.io/img/web/web-css-float-cancel-06.png)
...
![](https://wtj900.github.io/img/web/web-css-line-height-01.png)

需要注意的是，这个小技巧，行高=盒子高。  只适用于单行文本垂直居中！！不适用于多行。
如果想让多行文本垂直居中，需要设置盒子的padding：

![](https://wtj900.github.io/img/web/web-css-line-height-02.png)
...
`font-family`就是“字体”。family是“家庭”、“伐木累”的意思。
...
![](https://wtj900.github.io/img/web/web-css-a-link-01.png)
...
![](https://wtj900.github.io/img/web/web-css-background-01.png)
...
![](https://wtj900.github.io/img/web/web-css-background-02.png)

定位属性可以是负数：

![](https://wtj900.github.io/img/web/web-css-background-03.png)
...
![](https://wtj900.github.io/img/web/web-css-background-04.png)
...
![](https://wtj900.github.io/img/web/web-css-position-relative-01.png)
...
![](https://wtj900.github.io/img/web/web-css-position-relative-02.png)
...
![](https://wtj900.github.io/img/web/web-css-position-absolute-01.png)
...
绝对定位的参考点，如果用top描述，那么定位参考点就是`页面`的左上角，而不是浏览器的左上角：

![](https://wtj900.github.io/img/web/web-css-position-absolute-02.png)

如果用bottom描述，那么就是`浏览器首屏窗口尺寸`，对应的页面的左下角：

![](https://wtj900.github.io/img/web/web-css-position-absolute-03.png)

#### 2.3 以盒子为参考点

一个绝对定位的元素，如果父辈元素中出现了也定位了的元素，那么将以父辈这个元素，为参考点。

![](https://wtj900.github.io/img/web/web-css-position-absolute-04.png)
...
![](https://wtj900.github.io/img/web/web-css-position-absolute-05.png)

#### 2.4 绝对定位的盒子居中

绝对定位之后，所有标准流的规则，都不适用了。所以`margin:0 auto;`失效。

![](https://wtj900.github.io/img/web/web-css-position-absolute-06.png)
...
![](https://wtj900.github.io/img/web/web-css-z-index-01.png)
